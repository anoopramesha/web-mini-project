...
if ($conn->connect_error) {
    ...
    if(isset($_POST['Submit']))
    {
        ...
        echo 'window.location.href= "Movies.php";';  
        echo '</script>';
        }
    ...
    if(isset($_POST['sbmt']))
    {
        ...
        $result1 = mysqli_query($conn,"SELECT adminid, password FROM admin WHERE adminid = '".$adminid."' AND  password = '".$pswd."'");
...
<body>
    <img src="Images/Showtime.png" style="width: 30%;height: 30%;position: absolute;top: 25%; right:35%">
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="index.php" method="post">
    ...
    <div class="container" style="background-color:#f1f1f1">
      <span class="psw">Create Account<br><a base href="index.php">Signup?</a></span>
