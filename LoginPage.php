...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    if(isset($_POST['Submit']))
    {
        ...
        $result1 = mysqli_query($conn,"SELECT userid, password FROM account WHERE userid = '".$userid."' AND  password = '".$password."'");
        
        while($row=mysqli_fetch_assoc($result1))
        {
        $check_userid=$row['userid'];
...
?>
    ...
    if(isset($_POST['sbmt']))
    {
        ...
        $result1 = mysqli_query($conn,"SELECT adminid, password FROM admin WHERE adminid = '".$adminid."' AND  password = '".$password."'");
...
<body>
    <img src="C:\Users\Code.Bedroom-PC\Documents\Movie Booking System\Media\Showtime.png" style="width: 30%;height: 30%;position: absolute;top: 25%; right:35%">
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="LoginPage.php" method="post">
    <div class="imgcontainer">
      ...
      <img src="C:\Users\Code.Bedroom-PC\Documents\Movie Booking System\Media\Showtime.png" alt="Avatar" class="avatar">
    </div>
    ...
    <div class="container">
      ...
      <button type="Submit" name="Submit" style="border-radius: 10px; position: absolute;left:46%">Login</button>
    </div>

    <div class="container" style="background-color:#f1f1f1">
      <button type="button" onclick="document.getElementById('id01').style.display='none'" class="cancelbtn">Cancel</button>
      <span class="psw">Create Account<br><a base href="SignUp.php">Signup?</a></span>
  ...
  <form class="modal-content animate" action="LoginPage.php" method="post">
    ...
    <div class="container">
      ...
      <label><b>Password</b></label>
      <input type="password" placeholder="Enter Password" id="myInput1" name="password" required style="border-radius: 10px">
        
      <button type="submit" name="sbmt" style="border-radius: 10px; position: absolute;top:55%;left:46%">Login</button>
    </div>
  </form>
</div>
